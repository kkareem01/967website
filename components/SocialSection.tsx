...
export default function SocialSection() {
  return (
    <section className="bg-cream rounded-3xl py-10 px-4 sm:px-6 lg:px-8 md:py-14">
      <div className="max-w-2xl mx-auto text-center">
        <p className="font-inter text-[10px] tracking-[0.35em] uppercase text-caramel mb-3">
          Follow Along
        </p>
        <h2 className="font-dm-serif text-2xl md:text-3xl text-espresso mb-2">
          Stay connected with us.
        </h2>
        <p className="font-inter text-sm text-coffee/70 mb-8">
          New drinks, behind-the-scenes moments, and late-night vibes.
        </p>
        <div className="flex items-center justify-center gap-8">
          {socials.map((social) => (
            <a
              ...
              aria-label={`967 Coffee Co. on ${social.name}`}
              className="flex flex-col items-center gap-2 text-coffee/60 hover:text-caramel transition-colors"
            >
              {social.icon}
